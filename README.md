...
### 🎯2025.08 까지 목표
**1. 자격증 - 정보처리기사(2024.12)**, **SQLD(2025.06)**, **네트워크관리사 2급**

**2. 프로젝트 5개 이상 - 온라인 편의점(2024.08), 실시간 채팅앱(2025.04), MES 공정관리 시뮬레이션(2025.06), 게임 클라이언트 개발 라이브러리(진행중), IoT 스마트 어항(2025.08 예정)**
